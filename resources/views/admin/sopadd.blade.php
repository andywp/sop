            ...
            <form role="form" id="saveSOP" action="" enctype="multipart/form-data" >
                <div class="card-body">
                    ...
                    <div class="upload-file ">
							...
							<div class="preview"><div id="preview_images"><img src="{{ URL::asset('assets/img/default.jpg')  }}"/></div></div>
                            ...
                            <a id="btn_restore_images" href="javascript:void(0)" class="restoreFile" onclick="return restoreFile_images()" style="display:none"><i class="fa fa-reply"></i></a>
								...
								<input type="file" 
									...
									style="
										...
										height:100px;
									"
									onMouseOver="changeClassimages('on')"
									onMouseOut="changeClassimages('off')"
									onChange="return upload_images();"
									onClick="return hidemsg_images();"
								>
								</p>		
